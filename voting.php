...
<body>
    ...
    <p class="text-center">Sebelum melakukan Pemilihan, silakan pahami terlebih dahulu Syarat & Ketentuan serta Tata Tertib Pemilih</p>
    <div class="container mt-3 border rounded">
        ...
        <input type="checkbox" name="checkbox" id="checkbox"><b>Saya setuju dengan Syarat & Ketentuan Tersebut</b>
        <div class="text-center">
            <a href="voting_page.php"><button class="btn btn-primary mb-3 font-weight-bold " id="agree">Saya Setuju</button></a>
        </div>
    </div>
