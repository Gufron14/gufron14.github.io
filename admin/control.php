    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <div class="form-group">
                <label for="can_id">Nomor Kandidat:</label>
                <input type="text" name="can_id" id="can_id" class="form-control" placeholder="Nomor Kandidat" required>
            </div>
            <div class="form-group">
                <label for="can_name">Nama Kandidat:</label>
                <input type="text" name="can_name" id="can_name" class="form-control" placeholder="Candidate Name" required>
            </div>
            <div class="form-group">
                <label for="can_party">Calon Presiden Mahasiswa:</label>
                <input type="file" name="can_party" id="can_party" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="can_image">Calon Wakil Presiden Mahasiswa:</label>
...
?>
    ...
    <?php
        if(isset($_POST['edit_candidate']))
        {
            ...
            //Edit Calon Wakil Presiden Mahasiswa
            $can_image = $_FILES['can_image'];
			$can_image_filename = $can_image['name'];
			$can_image_fileerror = $can_image['error'];
			$can_image_filetmp = $can_image['tmp_name'];
            ...
            $update_result = mysqli_query($conn, $update_candidate_data);
